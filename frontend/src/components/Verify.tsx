...
export function Verify({
  ...
  const { data, isLoading, isError, error } = useProof(objectId)
  ...
  return (
    <section id="verify" className={`screen ${active ? 'active' : ''}`}>
      <div className="verify-wrap">
        ...
        {isLoading && <div className="ledger-state">Loading proof from chain…</div>}
        {isError && (
          <div className="ledger-state ledger-error">
            Couldn't load this proof: {error instanceof Error ? error.message : 'unknown error'}
          </div>
        )}
          ...
          <div className="verify-grid">
            <div>
              <div className="proof-media">
                <div>{data.photoUrl && <img className="proof-photo" src={data.photoUrl} alt="" />}</div>
            ...
            <div className="proof-detail">
              ...
              <div className="data-card">
                ...
                <div className="drow">
                  ...
                  <span className="dv link">{data.objectId}</span>
                </div>
                <div className="drow">
                  <span className="dk">Walrus blob</span>
                  <span className="dv link">{data.blob}</span>
                </div>
                <div className="drow">
                ...
                <div className="drow">
                  ...
                  <span className="dv">{data.ts}</span>
                </div>
                <div className="drow">
                ...
                {data.digest && (
                  <div className="drow">
                    ...
                    <span className="dv link">{data.digest}</span>
                  </div>
                )}
              </div>
